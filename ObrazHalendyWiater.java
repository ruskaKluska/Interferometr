...
// Iga stworzyła schemat, Monika dopracowała kolory, zmieniła klase
...
public class Picture {
	...
	public void paint (Graphics intG) {
		...
		lineHor1 = new Line2D.Double(90+(add),305,650,305);
		lineHor2 = new Line2D.Double(90+(add),315,650,315);
